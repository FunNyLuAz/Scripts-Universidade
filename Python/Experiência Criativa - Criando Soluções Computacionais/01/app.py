...
@app.route('/')  # Redireciona para a página principal por default
    ...
    return """
        <html>
            ...
            <body>
                ...
                <h3>Acesse o menu:</h3>
                <ul>
                    <h4><li><a href="/pedidos">Lista de pedidos</a></li></h4>
                </ul>
            </body>
        </html>
    """
...
@app.route('/pedidos')  # Redireciona para a página principal por default
...
if __name__ == "__main__":
    app.run()  # Executa o servidor (em localhost:5000 por default)
